...
public class V1_9Wither implements AbstractWither {
	...
	public static MEWither spawnWither(MEMain m, String arena, Location t) {
		...
		MEWither t_ = new MEWither(m, arena, t, (net.minecraft.server.v1_9_R1.World) ((CraftWorld) t.getWorld()).getHandle(), temp);
