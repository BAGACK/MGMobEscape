...
public class V1_9Dragon implements AbstractDragon {
	...
	public static MEDragon spawnEnderdragon(MEMain m, String arena, Location t) {
		...
		MEDragon t_ = new MEDragon(m, arena, t, (net.minecraft.server.v1_9_R1.World) ((CraftWorld) t.getWorld()).getHandle(), temp);
		((net.minecraft.server.v1_9_R1.World) w).addEntity(t_, CreatureSpawnEvent.SpawnReason.CUSTOM);
		System.out.println(((net.minecraft.server.v1_9_R1.World) w).entityList.contains(t_));
