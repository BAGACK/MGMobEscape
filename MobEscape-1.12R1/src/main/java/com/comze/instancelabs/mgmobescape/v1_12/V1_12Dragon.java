package com.comze.instancelabs.mgmobescape.v1_12;
...
public class V1_12Dragon implements AbstractDragon {
	...
	public static AbstractMEDragon spawnEnderdragon(MEMain m, String arena, Location t) {
		...
		MEDragon t_ = new MEDragon(m, arena, t, (net.minecraft.server.v1_12_R1.World) ((CraftWorld) t.getWorld()).getHandle(), temp);
