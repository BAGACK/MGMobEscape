...
public class V1_12Wither implements AbstractWither {
	...
	public static AbstractMEWither spawnWither(MEMain m, String arena, Location t) {
		...
		MEWither t_ = new MEWither(m, arena, t, (net.minecraft.server.v1_12_R1.World) ((CraftWorld) t.getWorld()).getHandle(), temp);
