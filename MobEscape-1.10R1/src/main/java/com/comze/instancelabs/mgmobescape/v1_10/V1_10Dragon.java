package com.comze.instancelabs.mgmobescape.v1_10;
...
public class V1_10Dragon implements AbstractDragon {
	...
	public static MEDragon spawnEnderdragon(MEMain m, String arena, Location t) {
		...
		MEDragon t_ = new MEDragon(m, arena, t, (net.minecraft.server.v1_10_R1.World) ((CraftWorld) t.getWorld()).getHandle(), temp);
		((net.minecraft.server.v1_10_R1.World) w).addEntity(t_, CreatureSpawnEvent.SpawnReason.CUSTOM);
		System.out.println(((net.minecraft.server.v1_10_R1.World) w).entityList.contains(t_));
